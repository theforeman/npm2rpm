...
TODOs:
  - Add option to choose strategy to follow
  - Fix bundle strategy to understand the '.tar' already contains node_modules. It currently fetches the list and adds them to Sources.
